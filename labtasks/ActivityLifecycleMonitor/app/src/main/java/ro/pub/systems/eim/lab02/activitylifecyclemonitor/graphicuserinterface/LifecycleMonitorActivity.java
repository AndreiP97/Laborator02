...
public class LifecycleMonitorActivity extends AppCompatActivity {
    ...
    protected void onSaveInstanceState(Bundle savedInstanceState) {
        ...
        if (rememberCheckBox.isChecked()) {
            ...
            savedInstanceState.putBoolean(Constants.REMEMBER_ME_CHECKBOX, rememberCheckBox.isChecked());
        }
    }
    ...
    protected void onRestoreInstanceState(Bundle savedInstanceState) {
        ...
        if (savedInstanceState.containsKey(Constants.REMEMBER_ME_CHECKBOX)) {
            ...
            rememberCheckBox.setChecked(savedInstanceState.getBoolean(Constants.REMEMBER_ME_CHECKBOX));
        }
    }
